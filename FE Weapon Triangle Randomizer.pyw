...
class App:
	...
	def writetable(self,relations,settings,mode):
		...
		style.add_class('reltab')
		style.edit_class('reltab','border','2px solid black')
		style.edit_class('reltab','border-collapse','collapse')
		style.edit_class('reltab','padding','5px')
		
		style.add_class('center')
		style.edit_class('center','margin','auto')
		style.edit_class('center','text-align','center')
		
		style.add_class('relcol')
		style.edit_class('relcol','border','1px solid black')
		style.edit_class('relcol','text-align','center')
		style.edit_class('relcol','width','60px')
		style.edit_class('relcol','height','40px')
		...
		#generate body
		d = tags.Tag('div')
		d.set_tag_attr('class','center')
		output.body.add_content(d)
		z = tags.Tag('h1')
		z.add_content('Weapon Relations Randomizer')
		d.add_content(z)
		#output settings
		z = tags.Tag('h2')
		z.add_content('Settings')
		d.add_content(z)
		box = tags.Tag('table')
		box.set_tag_attr('class','center')
		d.add_content(box)
		boxrow = tags.Tag('tr')
		box.add_content(boxrow)
		boxcol = tags.Tag('th')
		boxrow.add_content(boxcol)
		boxcol.add_content('Seed:')
		boxcol.set_tag_attr('style','text-align:right')
		boxcol = tags.Tag('td')
		boxrow.add_content(boxcol)
		boxcol.add_content(settings['seed'])
		boxrow = tags.Tag('tr')
		box.add_content(boxrow)
		boxcol = tags.Tag('th')
		boxrow.add_content(boxcol)
		boxcol.add_content('Mode:')
		boxcol.set_tag_attr('style','text-align:right')
		boxcol = tags.Tag('td')
		boxrow.add_content(boxcol)
		boxcol.add_content(self.modes[mode][0])
		...
		boxcol = tags.Tag('th')
		boxrow.add_content(boxcol)
		boxcol.add_content('Min')
		boxcol.set_tag_attr('style','padding: 5px')
		boxcol = tags.Tag('th')
		boxrow.add_content(boxcol)
		boxcol.add_content('Max')
		boxcol.set_tag_attr('style','padding: 5px')
		...
		boxcol = tags.Tag('th')
		boxrow.add_content(boxcol)
		boxcol.add_content('Accuracy:')
		boxcol.set_tag_attr('style','text-align:right')
		boxcol = tags.Tag('td')
		boxrow.add_content(boxcol)
		boxcol.add_content(str(min(settings['rhit'])))
		boxcol = tags.Tag('td')
		boxrow.add_content(boxcol)
		boxcol.add_content(str(max(settings['rhit'])))
		
		boxrow = tags.Tag('tr')
		box.add_content(boxrow)
		boxcol = tags.Tag('th')
		boxrow.add_content(boxcol)
		boxcol.add_content('Attack:')
		boxcol.set_tag_attr('style','text-align:right')
		boxcol = tags.Tag('td')
		boxrow.add_content(boxcol)
		boxcol.add_content(str(min(settings['ratk'])))
		boxcol = tags.Tag('td')
		boxrow.add_content(boxcol)
		boxcol.add_content(str(max(settings['ratk'])))
		
		boxrow = tags.Tag('tr')
		box.add_content(boxrow)
		boxcol = tags.Tag('th')
		boxrow.add_content(boxcol)
		boxcol.add_content('Count:')
		boxcol.set_tag_attr('style','text-align:right')
		boxcol = tags.Tag('td')
		boxrow.add_content(boxcol)
		boxcol.add_content(str(min(settings['rcnt'])))
		boxcol = tags.Tag('td')
		boxrow.add_content(boxcol)
		boxcol.add_content(str(max(settings['rcnt'])))
		
		boxrow = tags.Tag('tr')
		box.add_content(boxrow)
		boxcol = tags.Tag('th')
		boxrow.add_content(boxcol)
		boxcol.add_content('SingleRoll:')
		boxcol.set_tag_attr('style','text-align:right')
		boxcol = tags.Tag('td')
		boxrow.add_content(boxcol)
		boxcol.add_content(str(settings['rollonce']))
		
		boxrow = tags.Tag('tr')
		box.add_content(boxrow)
		boxcol = tags.Tag('th')
		boxrow.add_content(boxcol)
		boxcol.add_content('Symmetry:')
		boxcol.set_tag_attr('style','text-align:right')
		boxcol = tags.Tag('td')
		boxrow.add_content(boxcol)
		boxcol.add_content(str(settings['symmetry']))
		
		boxrow = tags.Tag('tr')
		box.add_content(boxrow)
		boxcol = tags.Tag('th')
		boxrow.add_content(boxcol)
		boxcol.add_content('Self Neutral:')
		boxcol.set_tag_attr('style','text-align:right')
		boxcol = tags.Tag('td')
		boxrow.add_content(boxcol)
		boxcol.add_content(str(settings['selfnull']))
		
		#generate table
		output.body.add_content(tags.BR)
		box = tags.Tag('table')
		output.body.add_content(box)
		box.set_tag_attr('class','center')
		boxrow = tags.Tag('tr')
		box.add_content(boxrow)
		boxcol = tags.Tag('td')
		...
		boxcol = tags.Tag('td')
		boxrow.add_content(boxcol)
		boxcol.add_content('DEFENDING')
		boxrow = tags.Tag('tr')
		box.add_content(boxrow)
		boxcol = tags.Tag('td')
		boxrow.add_content(boxcol)
		boxcol.add_content('ATTACKING')
		boxcol.set_tag_attr('style','writing-mode: vertical-rl; text-orientation: upright;')
		boxcol = tags.Tag('td')
		boxrow.add_content(boxcol)
		
		table = tags.Tag('table')
		boxcol.add_content(table)
		table.set_tag_attr('class','reltab')
		#header row
		row = tags.Tag('tr')
